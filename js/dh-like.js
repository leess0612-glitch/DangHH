/* ══════════════════════════════════════════════════════════════════════
   제품 상세 맨 아래 「비슷한 다른 제품」 칸 — 2026-09-22 라이브 (사장님 「올려」)
   ──────────────────────────────────────────────────────────────────────
   · 무엇을 보여 줄지는 js/dh-similar.js(색인)가 정합니다. 이 파일은 그리기만 합니다.
     색인은 손으로 고치지 말고 대본(gen5.js)으로 다시 뽑습니다 — 고르는 규칙은 dh-similar.js 머리말에 있습니다
     (기능 묶음 · 형태 · 직수/탱크 · 요금 폭 · 주요 브랜드 먼저 · 파생 제품 빼기 · LG 722·723 빼기 등).
   · 카드는 목록 화면 카드와 같은 재료로 만듭니다 — 사진 · 브랜드│모델 · 이름 · 월 요금.
   · 코웨이 전용 화면(/water-c/)에서는 같은 브랜드를 앞에 세우고, 카드도 /water-c/ 화면으로 잇습니다.
   · 폰에서는 화살표 없이 화면 끝에서 잘리게, 컴퓨터에서는 마우스용 화살표를 답니다.
   · 자료(data2-*.js)를 바꾸면 색인도 다시 뽑고 부르는 화면의 ?v= 를 올릴 것.
   ══════════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
